<template>
    ...
    <div class="mx-auto max-w-360 px-4 sm:px-6 lg:px-8 xl:px-12 space-y-16 py-12">
        ...
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-6 ">

            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center gap-3 min-h-62.5">
                <img src="/images/homePage/clock-up-arrow.png" alt="Up Time" class="w-16 h-16 object-contain">
                <p class="font-semibold">99.99%</p>
                <p>Up Time</p>
            </div>

            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center gap-3 min-h-62.5">
                <p class="font-semibold text-5xl md:text-6xl text-blue-950">
                    4.7
                </p>
                <img src="/images/homePage/star.png" alt="5 stat image" class="w-36">

                <div class="flex items-center gap-2">
                    <img src="/images/homePage/one-star.png" alt="One star" class="h-6">
            ...
            <div class="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center gap-3 min-h-62.5">
                <img src="/images/homePage/dolar-sign.png" alt="7-Day Money Back" class="w-16 h-16 mb-4 object-contain">
                <p class="font-semibold">7-Day Money Back</p>
                <p>Guarantee</p>
            </div>
